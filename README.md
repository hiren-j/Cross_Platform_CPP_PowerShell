...
| Rename File             | `move`, `mv`, `rename`                 | Rename **multiple files** in one command (auto indexing)                                 |
...
<br> 👉 [Click To Download App](https://github.com/hiren-j/Cross_Platform_CPP_PowerShell/blob/master/PowerX.exe)
